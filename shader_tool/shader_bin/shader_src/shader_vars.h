...
float4x4    inverseProjectionMatrix; //VERTEX_REGISTER( c8 ); // not used
...
// filterTap 0 (consts[21])
// [0][0] = xo_ssao_noisescale / xo_outliner_scale          (use case)
// [0][1] = xo_ssao_quality / xo_outliner_depthDiffScale    (use case)
// [0][2] = TextureSize.x / xo_outliner_depthThreshold
// [0][3] = TextureSize.y

// filterTap 1 (consts[22])
// [1][0] = xo_ssao_radius
// [1][1] = 
// [1][2] = 
// [1][3] = 

// filterTap 2 (consts[23])
// [2][0] = xo_ssao_contrast / xo_outliner_toonEnable       (use case)
// [2][1] = xo_ssao_attenuation / xo_outliner_toonShades    (use case)
// [2][2] = xo_ssao_angleBias
// [2][3] = 

// filterTap 3 (consts[24])
// [3][0] = 
// [3][1] = 
// [3][2] = 
// [3][3] = 

// filterTap 4 (consts[25])
// [4][0] = 
// [4][1] = 
// [4][2] = 
// [4][3] = 

// filterTap 5 (consts[26])
// [5][0] = 
// [5][1] = 
// [5][2] = 
// [5][3] = 

// filterTap 6 (consts[27]) / :::::::::::::::::: / within menus only
// [6][0] = ui_button_highlight_radius
// [6][1] = ui_button_highlight_brightness
// [6][2] = ui_button_outline_radius
// [6][3] = ui_button_outline_brightness

// filterTap 7 (consts[28]) / :::::::::::::::::: / within menus only
// [7][0] = ui_mouse.x
// [7][1] = ui_mouse.y
// [7][2] = xo_menu_dbg
// [7][3] = menu_gameTime       (like gameTime.w)
